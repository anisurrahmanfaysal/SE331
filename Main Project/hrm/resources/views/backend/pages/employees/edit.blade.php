                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturername">First
                                                    Name</label>
                                                <input id="manufacturername" name="fName" value="{{$employee->fName}}" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturerbrand">Last
                                                    Name</label>
                                                <input id="manufacturerbrand" name="lName" value="{{$employee->lName}}" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="price" name="email" value="{{$employee->email}}" type="text" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturername">Phone
                                                    Number</label>
                                                <input id="manufacturername" name="phone" value="{{$employee->phone}}" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="manufacturerbrand" name="address" value="{{$employee->address}}" type="text"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="price" name="joindate" value="{{$employee->joindate}}" type="date" class="form-control"
                                        ...
                                        <div class="col ms-auto">
                                            <div class="d-flex flex-reverse flex-wrap gap-2">
                                                <button type="submit" class="btn btn-outline-success"> <i
                                                        class="uil uil-file-alt"></i> Update Employee</button>
                                            </div>
                                        </div> <!-- end col -->
                                    </div> <!-- end row-->
